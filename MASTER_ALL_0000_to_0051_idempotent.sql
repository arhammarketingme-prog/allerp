...
-- ============================================================================
-- 0051_secure_delivery_pin_confirmation.sql
-- ============================================================================
-- ============================================================================
...
-- बॉयच्या ब्राउझरला आधीच खरा PIN पाठवला जायचा (`select delivery_pin`),
-- आणि जुळतो का हे browser मध्येच तपासलं जायचं — म्हणजे delivery boy
-- devtools/network मधून खरा PIN बघू शकत होता, ग्राहकाला विचारायची गरजच
-- नव्हती. OTP verification चा संपूर्ण उद्देशच निष्फळ होत होता.
-- ============================================================================
