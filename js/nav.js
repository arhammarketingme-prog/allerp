...
// 📲 खरं "App Install करा" बटण — आधी हे कुठेच नव्हतं, फक्त browser च्या
// स्वतःच्या (लपलेल्या, कमी दिसणाऱ्या) install आयकॉनवर अवलंबून होतं.
// आता एक आकर्षक, ठळक बॅनर दाखवतो — फक्त तेव्हाच जेव्हा ब्राउझर खरंच
// installable आहे असं सांगतो (beforeinstallprompt) आणि आधीच install/dismiss
// केलेलं नसेल.
...
window.addEventListener('beforeinstallprompt', (e) => {
  ...
  if (!localStorage.getItem('allerp_install_dismissed')) {
    showInstallBanner();
  }
});
...
function showInstallBanner() {
  ...
  banner.innerHTML = `
    <svg width="40" height="40" viewBox="0 0 100 100" style="flex-shrink:0; border-radius:9px;">
      ...
      <path d="M16 42 L22 24 Q23 22 25 22 L75 22 Q77 22 78 24 L84 42 Q84 46 80 46 Q76 46 76 42 Q76 46 71 46 Q66 46 66 42 Q66 46 61 46 Q56 46 56 42 Q56 46 50 46 Q44 46 44 42 Q44 46 39 46 Q34 46 34 42 Q34 46 29 46 Q24 46 24 42 Q24 46 20 46 Q16 46 16 42 Z" fill="#fff"/>
      <path d="M32 68 L44 56 L52 64 L68 48" fill="none" stroke="#facc15" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M60 48 L68 48 L68 56" fill="none" stroke="#facc15" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    <div style="flex:1; min-width:0;">
      <div style="font-weight:800; font-size:14px;">ALL ERP अ‍ॅप इंस्टॉल करा</div>
      <div style="font-size:11.5px; opacity:0.9;">जलद, ऑफलाइनही चालणारं, होम स्क्रीनवरून थेट उघडणारं</div>
    </div>
    <button id="allerp-install-btn" style="background:#fff; color:#1e3a8a; border:none; padding:8px 14px; border-radius:8px; font-weight:800; font-size:12.5px; cursor:pointer; white-space:nowrap;">इंस्टॉल</button>
    <button id="allerp-install-dismiss" style="background:transparent; border:none; color:#fff; font-size:18px; cursor:pointer; padding:0 4px; opacity:0.8;">✕</button>
  `;
  document.body.appendChild(banner);

  document.getElementById('allerp-install-btn').addEventListener('click', async () => {
  ...
  document.getElementById('allerp-install-dismiss').addEventListener('click', () => {
    localStorage.setItem('allerp_install_dismissed', '1');
    banner.remove();
  });
}
